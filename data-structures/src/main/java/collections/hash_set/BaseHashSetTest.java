...
public class BaseHashSetTest {

    public BaseHashSetTest(String name, double period) {}
    ...
    public void compareItemsInSet() {
        Set<BaseHashSetTest> mySets = new HashSet<>();
        mySets.add(new BaseHashSetTest("name", 100));
        mySets.add(new BaseHashSetTest("name", 200));
    }
